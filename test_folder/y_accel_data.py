...
y_accel_imu_save_path = "C:/Users/plane/Desktop/park_ws/test_folder/y_accel_imu_coordinates.xlsx"
y_accel_imu_workbook = openpyxl.Workbook()
y_accel_imu_sheet = y_accel_imu_workbook.active
y_accel_imu_sheet.title = "y_accel_imu_coordinates"
y_accel_imu_sheet.append(["y_accel_imu"])

def save_to_excel(sheet, y_accel_imu):
    """좌표 데이터를 엑셀에 저장하는 함수"""
    sheet.append([f"{y_accel_imu}"])
...
def handleSerialData(raw_data):
    global ie, buff, key, angle_degree, magnetometer, acceleration, angularVelocity, pub_flag
    if python_version == '2':
    ...
    if key < buff[2] + 5:  # 根据数据长度位的判断, 来获取对应长度数据
        ...
        save_to_excel(y_accel_imu_sheet, acceleration[1] * -9.8)
            ...
            try:
                ...
                if buff_count > 0:
                    ...
                    for i in range(0, buff_count):
                        ...
                        if ie != 0 and ie % 3000:
                            y_accel_imu_workbook.save(y_accel_imu_save_path)
