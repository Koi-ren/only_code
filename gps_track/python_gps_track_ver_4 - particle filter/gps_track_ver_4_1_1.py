...
def plot_coordinates(sheet, color, tooltip):
    for row in sheet.iter_rows(min_row=2, values_only=True):
        point_number, latitude, longitude, altitude = row
...
#button_corrected_workbook = openpyxl.load_workbook(button_corrected_save_path)
...
# 버튼으로 보정된 좌표 (노란색)
#plot_coordinates(button_corrected_sheet, "yellow", "Button Corrected Data")
