...
ROI_START_ROW = 160  # 차선을 찾을 ROI 영역의 시작 Row값
ROI_END_ROW = 200  # 차선을 찾을 ROT 영역의 끝 Row값
ROI_HEIGHT = ROI_END_ROW - ROI_START_ROW  # ROI 영역의 세로 크기  
L_ROW = 24  # 차선의 위치를 찾기 위한 ROI 안에서의 기준 Row값 
    ...
    while not rospy.is_shutdown():
        ...
        while drive_mode == LANE_DRIVE:
            ...
            if found:
                ...
                new_angle = (((x_left + x_right) //2 ) - 160 ) # 적절한 조향각을 찾아야 합니다.
            ...
            if (result == True):
                # 정지선이 발견되면 차량을 정차시키고 FINISH 모드로 넘어갑니다.
                drive_mode = FINISH  
